export const TitleText = () => {
  return (
    <div className="w-full pt-20 flex-1 relative flex overflow-visible flex-col items-center">
      <h1
        className="pt-[130px] text-[20px] sm:text-[120px] md:text-[180px] lg:text-[100px] font-cursive font-extrabold text-transparent 
