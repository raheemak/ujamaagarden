          ...
          <div className="flex flex-col">
            <section className="relative bg-amber-100 overflow-hidden">
              ...
              <div className="relative z-10 p-6 sm:p-10 ">
                <h1 className="text-amber-950 text-4xl sm:text-5xl lg:text-4xl tracking-tight">
                  CORE VALUES
                </h1>

                <ul className="text-amber-900 text-base sm:text-lg lg:text-md leading-relaxed space-y-1 max-w-prose pl-5">
            ...
            <section className="relative min-h-[420px] sm:min-h-[480px] overflow-hidden">
              ...
              {/* gradient tint */}
              <div className="absolute inset-0 bg-gradient-to-br from-amber-950/90 via-amber-900/80 to-amber-800/70" />

              {/* rectangles (matching your style) */}
              <div className="absolute top-0 left-0 w-16 h-full bg-amber-950 opacity-50" />
              <div className="absolute top-0 left-16 w-12 h-3/4 bg-amber-900 opacity-40" />
              <div className="absolute top-1/4 left-28 w-20 h-1/2 bg-amber-800 opacity-30" />

              <div className="absolute top-0 right-0 w-24 h-full bg-stone-200 opacity-20" />
              <div className="absolute top-1/3 right-24 w-20 h-2/3 bg-amber-700 opacity-25" />

              <div className="absolute bottom-0 left-0 w-24 h-1/3 bg-yellow-900 opacity-40" />
              <div className="absolute bottom-0 right-0 w-32 h-1/2 bg-amber-800 opacity-30" />

              <div className="relative z-10 px-6 sm:px-10 lg:px-12 py-8">
                <h1 className="text-white text-4xl sm:text-5xl lg:text-4xl mb-4">
                  OUR TEAM
                </h1>

                <p className="text-stone-100 text-base sm:text-lg leading-relaxed max-w-prose">
                  Ujamaa Garden was co-founded and is currently co-stewarded by
                  a vibrant team of young people from the North Bronx. We bring
                  diverse skills, perspectives, and values as a coalition of
                  organizers, artists, and educators. Ujamaa Garden receives
                  council and guidance from elders in the local community and
                  experts in food access and land stewardship.
                </p>
              </div>
            </section>
          </div>
